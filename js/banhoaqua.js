...
function renderOrderProduct() {
    ...
    if (arrDonHang.length == 0) {
        orderHtml = `<div class="empty-order-section"><img src="./assets/images/empty-order.jpg" alt="" class="empty-order-img"><p>Chưa có đơn hàng nào</p></div>`;
    } else {
            ...
            <article class="card-product" >
                ...
                <div class="food-info">
                    ...
                    <div class="product-buy">
                        <button onclick="detailProduct(${product.id})" class="card-button order-item"> Đặt hàng</button>
                    </div> 
                </div>
                </div>
            </article>
